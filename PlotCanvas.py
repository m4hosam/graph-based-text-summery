...
class PlotCanvas(FigureCanvas):
    ...
    def plot(self,sentences, similarityThreshold, min_score, model, tokenizer, model_option, theme_words_arr,title):
        self.figure.clear()
        ...
        #visualize graph
        summary = visualize_graph(graph, similarityThreshold, min_score,  theme_words_arr, title)
